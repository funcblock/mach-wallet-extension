...
export default function Connect({ params: { session } }: Props) {
      ...
      <Layout>
        ...
        <Content>
          <Column>
            ...
            <Text text="Your access to this page has been restricted by Mach Wallet as it might be unsafe." mt="md" />
          </Column>
        </Content>

        <Footer>
          <Row full>
            <Button text="Reject (blocked by Mach Wallet)" preset="danger" onClick={handleCancel} full />
          </Row>
        </Footer>
      </Layout>
    );
  ...
  return (
    <Layout>
      ...
      <Content>
        <Column>
          <Text text="Connect with Mach Wallet" preset="title-bold" textCenter mt="lg" />
