        ...
        <Column gap="zero">
          ...
          <div style={{ marginTop: 8 }}>
            <Checkbox
              ...
              <div style={{ fontSize: fontSizes.sm }}>
                for Ordinals assets, <span style={{ color: '#ab9ff2' }}>Rare sats </span>are not supported.
              </div>
            </Checkbox>
          </div>
          ...
          <div>
            <Checkbox checked={checked2} onChange={(e) => setChecked2(e.target.checked)}>
              <div style={{ fontSize: fontSizes.sm }}>
                for Atomicals assets, <span style={{ color: '#ab9ff2' }}>Non-ARC20</span> are not supported yet.
              </div>
            </Checkbox>
          </div>
        </Column>
